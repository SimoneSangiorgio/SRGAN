...
training_images_path = "C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/training_set/"
testing_images_path = "C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/testing_set/"
res_im_path = "C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/training_results/"
...
if mode == "evaluate":
  ...
  generator.load_weights(os.path.join(models_path , "trained_model.h5"))
  ...
  for i in range(1):
      high_resolution_images, low_resolution_images = next(dataloader)
      generated_images = generator.predict_on_batch(low_resolution_images)
      save_images("C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/evaluation_images/" + "img{}.jpeg".format(i), low_resolution_images[0], generated_images[0] , high_resolution_images[0])
      ...
      save_images("C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/evaluation_images/" + "img{}_bilinear.jpeg".format(i), low_resolution_images[0], upscaled_images_bilinear, high_resolution_images[0])
      save_images("C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/evaluation_images/" + "img{}_bicubic.jpeg".format(i), low_resolution_images[0], upscaled_images_bicubic, high_resolution_images[0])
      save_images("C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/evaluation_images/" + "img{}_lanczos.jpeg".format(i), low_resolution_images[0], upscaled_image_lanczos, high_resolution_images[0])
...
if mode == "generate":
  ...
  def reassemble_images(pieces, original_width, original_height):
      ...
      new_image.save("C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/upscaled_images/upscaled_image.jpg")


  pieces, original_width, original_height = divide_image("C:/Users/simon/OneDrive/Desktop/Super Resolution/SRGAN/images/images.jpg")
